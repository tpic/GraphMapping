	...
	public static Collection<Object[]> data() {
		return Arrays
				.asList(new Object[][] {
						...
						{ "Barbara -- friend [ since = 1999 ] --> Carol", true },
						{ "Barbara--friend[share=[books,film,music]]-->Carol", true },
						{ "Barbara--friend[since=1999,share=books]-->Carol", true },
						{
